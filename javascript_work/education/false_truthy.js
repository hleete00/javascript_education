...
if (10.23) { console.log('positive floats are truthy'); }
if (-10.23) { console.log('negative floats are truthy'); }
if (Infinity) { console.log('positive infinity are truthy'); }
if (-Infinity) { console.log('negative infinity are truthy'); }
